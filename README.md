...
Guía detallada paso a paso: [`docs/INSTRUCCIONES-INICIO.md`](docs/INSTRUCCIONES-INICIO.md)
...
El repositorio expone **tres carpetas principales** más este README:
...
| Informe / presentación / diagramas PDF | 📄 En [`docs/`](docs/) |
