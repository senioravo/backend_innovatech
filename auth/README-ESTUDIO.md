...
- [BFF README-ESTUDIO](../services/bff/README-ESTUDIO.md) — orquestación de login
- [PM README-ESTUDIO](../services/project-manager/README-ESTUDIO.md) — validación del mismo JWT
