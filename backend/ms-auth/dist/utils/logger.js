...
class Logger {
    ...
    formatLogMessage(status, options = {}) {
        const { userId = 'N/A', operation = 'UNKNOWN', detail = '', email = 'N/A', ip = 'N/A', taskId = 'AS-TASK-13', responseTime = null } = options;
    ...
    logCriticalOperation(operation, data = {}) {
        const { success = true, userId = null, email = null, ip = null, detail = '', error = null, responseTime = null, taskId = 'AS-TASK-13' } = data;
        const options = {
            userId,
            email,
            ip,
